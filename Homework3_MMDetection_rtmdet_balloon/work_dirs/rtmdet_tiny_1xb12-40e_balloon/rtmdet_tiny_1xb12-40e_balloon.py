...
log_level = 'INFO'
load_from = '../hw3/work_dirs/rtmdet_tiny_1xb12-40e_balloon/best_coco_bbox_mAP_epoch_40.pth'
resume = False
train_cfg = dict(
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='../hw3/data/balloon/val.json',
    metric='bbox',
    format_only=False,
    backend_args=None,
...
val_num_workers = 2
num_epochs_stage2 = 5
work_dir = '../hw3/work_dirs/rtmdet_tiny_1xb12-40e_balloon'
launcher = 'none'
