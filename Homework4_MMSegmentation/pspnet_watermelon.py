...
metainfo = {
        'classes':['Red', 'Green', 'White', 'Vegetation', 'Seed-black', 'Seed-white'],
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', by_epoch=False, interval=300, max_keep_ckpts=2, save_best='auto'),
