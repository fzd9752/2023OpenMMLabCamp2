...
log_processor = dict(
    ...
    _scope_='mmpose')
log_level = 'INFO'
load_from = '../hw1/work_dirs/rtmpose_s_ear/best_PCK_epoch_290.pth'
resume = False
...
data_mode = 'topdown'
data_root = '../hw1/Ear210_Keypoint_Dataset_coco/'
work_dir = '../hw1/work_dirs/rtmpose_s_ear'
dataset_info = dict(
...
val_evaluator = [
    dict(
        type='CocoMetric',
        ann_file='../hw1/Ear210_Keypoint_Dataset_coco/val_coco.json'),
